...
const Benifit = () => {
  return (
    <div>
      <div className="pt-20 px-20 md:px-14 lg:px-24 bg-slate-100 pb-10">
       ...
       <h1 className="text-5xl font-medium mt-3">Why Choose FindHusly</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 mt-16 ">
          ...
          <div className="w-96 text-center">
            <img
              className="w-20 animate__animated animate__flip mx-auto"
             src={customize}
              alt=""
            />
            <h1 className="mt-10 text-2xl font-semibold ">Customized Solutions</h1>
            <p className="text-gray-600 mt-6 text-lg">
          ...
          <div className="w-96 text-center">
            <img
             ...
             src={ownerShip}
              alt=""
            />
            <h1 className="mt-10 text-2xl font-semibold">Transparent Partnerships</h1>
            <p className="text-gray-600 mt-6 text-lg">
